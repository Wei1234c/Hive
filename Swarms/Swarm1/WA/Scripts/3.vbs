...
taskID = "8782771153780"
targetedURL = "http://ipac.library.taichung.gov.tw/toread/opac/Advancedsearch.page?classification_type=all&level=all&limit=20&location=3&material_type=all&q=isbn_issn%3A8782771153780&source=local&view=CONTENT&wi=false"
httpMethod = "GET"
